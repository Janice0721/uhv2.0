package org.jeecg.modules.sanshi.uhv.Construction.entity;
...
@ApiModel(value="construction_message对象", description="construction_message")
public class ConstructionMessage implements Serializable {
	...
	/**塔杆id*/
	@Excel(name = "塔杆id", width = 15)
    @ApiModelProperty(value = "塔杆id")
	...
	/**是否完成复测分抗*/
	@Excel(name = "是否完成复测分抗", width = 15)
    @ApiModelProperty(value = "是否完成复测分抗")
