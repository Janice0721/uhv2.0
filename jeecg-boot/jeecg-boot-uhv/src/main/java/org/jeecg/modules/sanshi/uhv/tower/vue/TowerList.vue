<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('塔杆信息')">导出</a-button>
    ...
    <a-tabs defaultActiveKey="1">
      <a-tab-pane tab="属地供电所填报" key="1" >
        <TerritorialMessageList :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="施工填报" key="2" forceRender>
        <ConstructionMessageList :mainId="selectedMainId" />
      </a-tab-pane>
    </a-tabs>

    <tower-modal ref="modalForm" @ok="modalFormOk"></tower-modal>
  </a-card>
</template>
...
<script>
  ...
  import TerritorialMessageList from './TerritorialMessageList'
  import ConstructionMessageList from './ConstructionMessageList'
  ...
  export default {
    ...
    components: {
      TerritorialMessageList,
      ConstructionMessageList,
      TowerModal
    },
    data () {
      return {
        ...
        url: {
          ...
          delete: "/tower/tower/delete",
          deleteBatch: "/tower/tower/deleteBatch",
          exportXlsUrl: "/tower/tower/exportXls",
          importExcelUrl: "tower/tower/importExcel",
        },
        dictOptions:{
        },
        /* 分页参数 */
